        ...
        try:
            ...
            tg_msg = {
                "messages": self._build_fallback_messages(
                    "You optimize a prompt template.", current_prompt.prompt_template.template
                )
            }
        self._log(
            logging.DEBUG,
    ...
    async def textual_gradient_and_apply_edit(
        ...
        *,
        ...
        try:
            ...
            ae_msg = {
                "messages": self._build_fallback_messages(
                    f"Apply prompt edit for: {current_prompt.prompt_template.template[:50]}", critique_text
                )
            }
