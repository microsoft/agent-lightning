...
#### Accuracy versus finale cost

Each benchmark uses the \$5 nominal-budget group and shows seven points: the pristine baseline plus Claude Code, Codex, and Copilot with and without the skill. The x-axis is average finale cost; the y-axis is held-out finale accuracy.

![SpreadsheetBench accuracy versus finale cost](assets/agent-lightning-spreadsheetbench-accuracy-finale-cost.svg)

![OfficeQA accuracy versus finale cost](assets/agent-lightning-officeqa-accuracy-finale-cost.svg)

#### \$5 budget snapshot

| Benchmark (train/test) | Result | Accuracy (%) | Finale cost |
| :--- | :--- | ---: | ---: |
