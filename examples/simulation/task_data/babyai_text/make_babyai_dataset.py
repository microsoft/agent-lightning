...
train_df.to_parquet("examples/simulation/task_data/babyai_text/train.parquet", engine="pyarrow", index=False)
print("Parquet file saved: train.parquet")

# Test dataset
test_data_size = 60
test_df = make_balanced_dataset(test_data_size, supported_tasks)
test_df.to_parquet("examples/simulation/task_data/babyai_text/test.parquet", engine="pyarrow", index=False)
