...
def train_agent():
    ...
    train_dataset = [
        NewsTask(
            query="Tell me news about Bitcoin",
            expected_keywords=["Bitcoin", "cryptocurrency", "price", "market"]
        ),
        NewsTask(
    ...
    val_dataset = [
        NewsTask(
            ...
            expected_keywords=["Tesla", "electric", "vehicle", "Elon"]
        ),
        NewsTask(
            query="What's the sum of 25 and 37?",
            expected_keywords=["62", "sum", "25", "37"]
        ),
    ]
    ...
    trainer = agl.Trainer(
        ...
        n_runners=4,
        initial_resources={
            "prompt_template": get_baseline_prompt_template()
        },
